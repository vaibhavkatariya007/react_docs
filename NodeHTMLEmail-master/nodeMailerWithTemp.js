...
var sender = 'smtps://vaibhav.katariya086%40gmail.com'; // The emailto use in sending the email(Change the @ symbol to %40 or do a url encoding )
var password = 'Simran@007'; // password of the email to use
...
var sendResetPasswordLink = transporter.templateSender(
  ...
  {
    from: 'vaibhav.katariya086@gmail.com',
  }
);
